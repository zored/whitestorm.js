(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["SocketModule"] = factory();
	else
		root["SocketModule"] = factory();
})(this, function() {
...
var SocketModule = function () {
  function SocketModule() {
    ...
    _classCallCheck(this, SocketModule);
    ...
    this.socket.on('connect', function () {
      console.info('Socket connected to ' + _this.socketServer);
    });

    this.socket.on('event', function () {}); // this takes data

    this.socket.on('disconnect', function () {
      console.info('Socket disconnected from ' + _this.socketServer);
    });
  }

  _createClass(SocketModule, [{
    key: 'manager',
    value: function manager(_manager) {
      _manager.add('socket', this.socket);
    }
  }, {
    key: 'onNewMesh',
    value: function onNewMesh(cb) {
      var meshes = this.meshes;

      this.socket.on('new-mesh', function (msg) {
        var material = null;
    ...
    value: function integrate(self) {
      ...
      this.sockit = function () {
        _this2.uuid = self.generateUid();
        var mesh = {
          geometry: _this2.geometry,
          position: _this2.position,
          material: _this2.material,
          shadow: _this2.shadow
        };

        self.meshes.set(_this2.uuid, _this2);
      ...
      this.emitPosition = function (params) {
        var mesh = self.meshes.get(this.uuid);
